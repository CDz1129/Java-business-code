package com.cdz.javacode.fsm;// Licensed to the Apache Software Foundation (ASF) under one
...
public class Main {
    ...
    public static void main(String[] args) {
        StateMachineConfig config = new StateMachineConfig<State, Trigger>();
        ...
        StateMachine<State, Trigger> fsm = new StateMachine(State.IDLE, config);
